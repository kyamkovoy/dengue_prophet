...
def get_targets(input_data):
    ...
    for model in model_list:
        print("forecasting for district " + district[j])
        ...
        all_forecasts.append([year_total, year_peak, peak_biweek, biweek_cases, probability])
...
with open('../output/all_targets_test_prob.txt', 'wb') as file:
